...
| [../backend/README.md](../backend/README.md) | The V2 service: how to run it, its configuration, and the development library namespace that stands in for authentication |
...
yet, apart from the backend foundation in `backend/`. Where one of them and
